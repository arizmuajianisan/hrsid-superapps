  ...
  <div>
    <div class="mb-6">
      ...
      <p class="text-muted mt-1">
        Akses semua aplikasi yang tersedia untuk departemen Anda
      </p>
    </div>
      ...
      >
        <UCard class="h-full transition hover:ring-2 hover:ring-primary cursor-pointer">
          <div class="flex flex-col items-center text-center gap-3 py-2">
            <div class="size-14 rounded-xl bg-primary/10 flex items-center justify-center overflow-hidden">
              <img
            ...
            <div>
              <p class="font-semibold group-hover:text-primary transition-colors">{{ application.name }}</p>
